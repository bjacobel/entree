/**
 * entree's CloudFormation template supports both apps hosted at the root domain (e.g., https://entree.com)
 * and apps hosted on a subdomain (what is configured below, https://entree.bjacobel.com).
...
const config = {
  ...
  ProjectFQDomain: 'entree.bjacobel.com',
