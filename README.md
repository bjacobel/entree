<img src="https://entree.bjacobel.com/logo.svg" alt="entree" width="200px">

[![Build Status](https://github.com/bjacobel/entree/actions/workflows/integration.yml/badge.svg?branch=master&event=push)](https://github.com/bjacobel/entree/actions/workflows/integration.yml) [![codecov](https://codecov.io/gh/bjacobel/entree/branch/master/graph/badge.svg)](https://codecov.io/gh/bjacobel/entree) [![Renovate](https://img.shields.io/badge/renovate-enabled-brightgreen.svg)](https://renovatebot.com)

entree (React App Kit) is an opinionated skeleton to quickly set up a project with React, Babel, Webpack & friends.

### What's inside

entree includes and configures the following components to help you build a rock-solid, scalable app with best practices and zero configuration.
...
entree requires Node 20. In addition, to use the automatic AWS deployment features, you'll need both an AWS account and a GitHub account.

Start a new Project with entree by creating an empty directory and installing `entree` into it.

    mkdir my-new-project
    cd my-new-project

Next, run `entree` using `npx`. It doesn't take any arguments, and will set up a project using the name of the folder you created as the project name.

    npx entree

You can also use the latest master version of `entree` by running:

    npx bjacobel/entree

Some details about your newly created folder structure and dependencies will be printed while entree is setting up. After it's done, commit your project to git:
